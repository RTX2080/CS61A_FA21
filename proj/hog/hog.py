...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    score,ans=0,10
    for i in range(1,11):
        avg = make_averaged(roll_dice,total_samples)(i,dice)
        # print(i)
        # print(avg)
        if avg>score:
            score=avg
...
def tail_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    bailanpt = tail_points(opponent_score)
    if bailanpt>=threshold:
        return 0
    else:
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    bailan = square_update(0,score,opponent_score)
    if bailan>=score+threshold:
        return 0
    else:
        return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
