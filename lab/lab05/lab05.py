...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    tmp = make_city('s',lat,lon)
    return get_name(city_a) if distance(city_a,tmp)<distance(city_b,tmp) else get_name(city_b)
...
def berry_finder(t):
    ...
    for i in range(len(l)):
        ans = ans or berry_finder(l[i])
    ans = ans or label(t)=='berry'
    return ans
